...
class MaquinaController extends Controller
{
    ...
    public function Crear(Request $toRequest): JsonResponse
    {
        $toRequest->validate([
            ...
            'TipoInternet' => ['nullable', 'integer', 'min:1', 'exists:mysqlNegocio.TIPOINTERNET,TipoInternet'],
            'ConsumoKwhMensual' => ['nullable', 'numeric', 'min:0', 'max:50000'],
    ...
    public function ActualizarParcial(Request $toRequest, int $IdMaquina): JsonResponse
    {
        $toRequest->validate([
            ...
            'TipoInternet' => ['sometimes', 'nullable', 'integer', 'min:1', 'exists:mysqlNegocio.TIPOINTERNET,TipoInternet'],
            'ConsumoKwhMensual' => ['sometimes', 'nullable', 'numeric', 'min:0', 'max:50000'],
